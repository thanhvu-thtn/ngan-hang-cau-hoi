<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            <a href="{{ route('shared-contexts.show', $sharedContext) }}"
            ...
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                Chỉnh sửa: <span class="text-blue-700">{{ $sharedContext->code }}</span>
            </h2>
        </div>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <form action="{{ route('shared-contexts.update', $sharedContext) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text"
                                id="code"
                                name="code"
                                value="{{ old('code', $sharedContext->code) }}"
                        ...
                        <div>
                            ...
                            <input type="text"
                                id="description"
                                name="description"
                                value="{{ old('description', $sharedContext->description) }}"
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                class="block w-full px-3 py-2 border rounded-lg text-sm shadow-sm transition resize-y
                                    focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500
                                    {{ $errors->has('content') ? 'border-red-400 bg-red-50' : 'border-gray-300' }}">{{ old('content', $sharedContext->content) }}</textarea>
                            @error('content')
                                <p class="mt-1.5 text-xs text-red-600 flex items-center gap-1">
                                    <svg class="w-3.5 h-3.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/>
                    ...
                    <div class="px-6 py-4 bg-gray-50 border-t border-gray-200 flex items-center justify-end gap-3">
                        ...
                        <button type="submit"
                            class="inline-flex items-center px-6 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-bold rounded-lg transition shadow-md">
