<x-app-layout>
    <x-slot name="header">
        ...
        <p class="mt-2 text-sm text-gray-700">Cập nhật thông tin cho tài khoản: <span
    ...
    <div class="max-w-2xl mx-auto mt-8">
        ...
        <div class="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl md:col-span-2">
            <form action="{{ route('users.update', $user->id) }}" method="POST">
                @csrf
                @method('PUT') <div class="px-4 py-6 sm:p-8">
                    <div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <div class="sm:col-span-4">
                            <label for="password" class="block text-sm font-medium leading-6 text-gray-900">Mật khẩu mới
                                <span class="text-gray-400 font-normal">(Bỏ trống nếu không muốn đổi)</span></label>
                            <div class="mt-2">
                        ...
                        <div class="sm:col-span-4">
                            <label for="password_confirmation"
                                class="block text-sm font-medium leading-6 text-gray-900">Nhập lại mật khẩu mới</label>
                            <div class="mt-2">
                ...
                <div
                    ...
                    <a href="{{ route('users.index') }}" class="text-sm font-semibold leading-6 text-gray-900">Hủy</a>
                    <button type="submit"
