<nav class="bg-gray-800">
            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="#"
                            class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Ngân
                            hàng câu hỏi</a>
                    </div>
                </div>
            </div>
                ...
                <div class="ml-4 flex items-center md:ml-6">
                    ...
                    <div class="relative ml-3" x-data="{ open: false }">
                        ...
                        <div x-show="open" 
                            ...
                            <div class="block px-4 py-3 text-sm text-gray-700 border-b border-gray-100 bg-gray-50/50">
    ...
    <div class="md:hidden" id="mobile-menu">
        <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
            ...
            <a href="#"
                class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Ngân
                hàng câu hỏi</a>
        </div>
